...
def run_detection(enterprise_keywords=[], org=[], repo=[], filter_archived=False, filter_forks=False):
    """
    Run GitHub search
...
if __name__ == "__main__":
    ...
    run_detection(enterprise_keywords, org, repo, filter_archived, filter_forks)
